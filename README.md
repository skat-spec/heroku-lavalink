# heroku-lavalink
Easily deploy a [Lavalink](https://github.com/freyacodes/Lavalink) Node on heroku.
This will automatically download the latest Lavalink jar file.

*To update your Lavalink.jar, restart all dynos (faster) or redeploy.*

### Deploy:
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/decodercc/heroku-lavalink)
